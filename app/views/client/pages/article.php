            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= Router::url('') ?>">Home</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 d-flex justify-content-between mb-2">
                    <a href="<?= Router::url('article/' . $article['id'] - 1) ?>"><button class="btn btn-primary">Prev</button></a>
                    <a href="<?= Router::url('article/' . $article['id'] + 1) ?>"><button class="btn btn-primary">Next</button></a>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
